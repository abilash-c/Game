(function () {
  ...
  var Block = UnblockMe.Block = function (options) {
    ...
    this.color = options.color || '#008DB1';
  ...
  Block.prototype.reachScreenEdge = function (dir) {
    ...
    else if (this.pos[0] + this.width === UnblockMe.Game.DIM_X && dir === "r") { return true; }
    else if (this.pos[1] === 0 && dir === "t") { return true; }
    else if (this.pos[1] + this.height === UnblockMe.Game.DIM_Y && dir === "b") { return true; }
    else { return false; }
  };
})();
